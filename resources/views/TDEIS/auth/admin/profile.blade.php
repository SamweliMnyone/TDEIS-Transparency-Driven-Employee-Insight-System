...
@section('yes')
    <title>TDEIS | Admin Profile</title>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.profile') }}">Update Profile</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="animated fadeIn">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('admin.profile.update') }}" method="post" class=""
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('admin.profile.update-password') }}" method="post" class="">
                            @csrf
                            @method('PUT')
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('admin.profile.delete-account') }}" method="post" class=""
