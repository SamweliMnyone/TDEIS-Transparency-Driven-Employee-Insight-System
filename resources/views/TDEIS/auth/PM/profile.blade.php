...
@section('yes')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('pm.profile.update') }}" method="post" class="" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('pm.profile.update-password') }}" method="post" class="">
                    @csrf
                    @method('PUT')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('pm.profile.delete-account') }}" method="post" class="" id="deleteAccountForm">
                    @csrf
                    @method('DELETE')
